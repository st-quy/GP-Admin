...
const QuestionDetail = () => {
  ...
  const questionData = {
    ...
    options: [
      ...
      {
        key: 'B',
        text: 'The development of modern architecture',
        isCorrect: true,
      },
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6'>
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <div className='flex items-center gap-2'>
                  <Avatar
                    src={questionData.updater.avatar}
                    size='small'
                    icon={<UserOutlined />}
                  />
                  <Text className='font-bold text-[#111827]'>
                    {questionData.updater.name}
                  </Text>
                </div>
              </div>
              <div>
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <div className='flex items-center gap-2'>
                  <Avatar
                    src={questionData.creator.avatar}
                    size='small'
                    icon={<UserOutlined />}
                  />
                  <Text className='font-bold text-[#111827]'>
                    {questionData.creator.name}
                  </Text>
                </div>
              </div>
              <div>
              ...
              {questionData.options.map((option) => (
                ...
                >
                  <div className='flex items-center gap-4'>
                    ...
                    <span
                      className={`font-medium ${option.isCorrect ? 'text-[#111827]' : 'text-gray-600'}`}
                    >
                      {option.text}
                    </span>
                  </div>
