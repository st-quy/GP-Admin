...
const TopicListPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      render: (_, record) => {
        const canModify = record.Status === "submited" || record.Status === "approved";
        return (
          <Space size="middle">
            <Button
              type="text"
            ...
            <Card className="shadow-sm border-none">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-semibold mt-1">{counts.Submited}</div>
                </div>
            ...
            <Card className="shadow-sm border-none">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-semibold mt-1">{counts.Draft}</div>
                </div>
            ...
            <Card className="shadow-sm border-none">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-semibold mt-1">{counts.Rejected}</div>
                </div>
