                                    ...
                                    <>
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <div className="flex items-center gap-2">
                                                <SwapOutlined style={{ color: '#003087', fontSize: '18px' }} />
                                                <span className="text-[16px] font-semibold text-[#111827]">Randomization Settings</span>
                                            </div>
                                            <Row gutter={48}>
                                                <Col>
                                                    <Space>
                                                        ...
                                                        />
                                                        <Text className="text-[#374151] font-medium">Shuffle Questions (G&V only)</Text>
                                                    </Space>
                                                </Col>
                                                <Col>
                                                    <Space>
                                                        ...
                                                        />
                                                        <Text className="text-[#374151] font-medium">Shuffle Answers</Text>
                                                    </Space>
                                                </Col>
                                            </Row>
                                        </div>
